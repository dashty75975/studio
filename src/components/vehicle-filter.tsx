...
import { Car, Bus, Truck, Bike, Users2, Grip } from 'lucide-react';
...
const vehicleTypes: { value: VehicleType | 'all'; label: string; icon: React.ReactNode }[] = [
  ...
  { value: 'minibus', label: 'Minibus', icon: <Users2 className="h-4 w-4" /> },
...
export default function VehicleFilter({ vehicleType, setVehicleType }: VehicleFilterProps) {
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10 bg-background/80 backdrop-blur-sm p-1 rounded-lg shadow-lg flex gap-1">
